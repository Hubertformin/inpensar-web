                        ...
                        <TabPanels>
                                ...
                                <div className="row">
                                    <div className="col-sm-6">
                                        <FormControl className="mb-4">
                                            ...
                                            <InputGroup>
                                                <InputLeftAddon bg={'orange.100'}
                                                                color={'orange.500'}>FCFA</InputLeftAddon>
                                                <Input
                                                    name="amount"
                            ...
                            <TabPanel>
                                ...
                                <FormControl className="mb-4">
                                    <FormLabel>Amount</FormLabel>
                                    <InputGroup>
                                        <InputLeftAddon bg={'orange.100'} color={'orange.500'}>{authUser.settings.currency}</InputLeftAddon>
                                        <Input
                                            name="amount"
