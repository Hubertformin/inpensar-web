        ...
        <ViewLayout pageTitle={'Projects'}>
            ...
            {isPageLoading ?
                ...
                (<div className="body md:flex">
                    ...
                    <div onClick={() => newProjectDisclosure.onOpen()} className="border w-full md:w-1/3 xl:w-24 cursor-pointer text-slate-500 rounded border-dotted min-h-100 flex items-center justify-center md:mr-4 mb-4 px-4 py-3">
            ...
            <Modal
                onClose={closeModal}
                isOpen={newProjectDisclosure.isOpen}
                size="sm"
