import {
    ...
    StatHelpText,
    StatLabel,
    StatNumber, Modal, ModalOverlay, ModalContent, ModalBody, ModalFooter, useDisclosure,
        ...
        <ProjectViewLayout title={'Transactions'}>
            <main className={`page-view px-3 md:px-6 py-6`}>
                ...
                <div className="pg-header-sm md:hidden mb-4">
                    <div
                        className="border border-purple-500 w-auto rounded-full text-purple-900 bg-purple-50 h-8 w-24 px-3 font-medium flex items-center gap-2">
            ...
            <Modal
                onClose={accountWarningDis.onClose}
                isOpen={accountWarningDis.isOpen}
                size="lg"
                ...
                <ModalContent>
                    <ModalBody>
                        ...
                        <p className="text-slate-500 text-center text-sm">
                            To ensure accurate and up-to-date balances in your records, we kindly ask you to list your
                            bank account within the app. This information allows us to fetch the latest transaction data
                            and update your balances accordingly. It&apos;s important to note that this process does not
                            involve linking the app directly to your bank account or providing access to your account
                            details. Listing your bank account is a
                            simple step to help you stay on top of your financial information. <br/>
                            Thank you for your
                    ...
                    <ModalFooter>
                        <ButtonGroup spacing={4}>
                            ...
                            <Button
                                onClick={() => router.push(`/projects/${activeProject.id}/accounts`)}
                                colorScheme="brand"
                            >
                                Set up Accounts
                            </Button>
